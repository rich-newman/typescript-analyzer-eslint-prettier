...
module.exports = {
    ...
    // espree (JavaScript) parser specified, test should show it doesn't work with our TypeScript a.ts input file
	"parser": "espree", // TypeScript parser used for both .js and .ts files
    "plugins": [
        "@typescript-eslint",
        "prettier"
    ],
