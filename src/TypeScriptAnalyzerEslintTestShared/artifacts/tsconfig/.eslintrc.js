...
module.exports = {
    ...
    "rules": {
        // Below are all of the rules from eslint:recommended https://github.com/eslint/eslint/blob/master/conf/eslint-recommended.js (all errors set to warning)
        ...
        // Other rules
        "default-param-last": 1,                  // https://eslint.org/docs/rules/default-param-last
        "eqeqeq": 1,                               // https://eslint.org/docs/rules/eqeqeq
        ...
        //"react/display-name": 1,                    // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/display-name.md
        //"react/no-children-prop": 1,                // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-children-prop.md
        ...
        //"react/no-deprecated": 1,                   // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-deprecated.md
        //"react/no-direct-mutation-state": 1,        // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-direct-mutation-state.md
        //"react/no-find-dom-node": 1,                // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-find-dom-node.md
        //"react/no-is-mounted": 1,                   // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-is-mounted.md
        //"react/no-render-return-value": 1,          // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-render-return-value.md
        //"react/no-string-refs": 1,                  // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-string-refs.md
        //"react/no-unescaped-entities": 1,           // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-unescaped-entities.md
        ...
        //"react/require-render-return": 1,           // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/require-render-return.md
        //"react/jsx-key": 1,                         // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-key.md
        //"react/jsx-no-comment-textnodes": 1,        // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-no-comment-textnodes.md
        //"react/jsx-no-duplicate-props": 1,          // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-no-duplicate-props.md
        //"react/jsx-no-target-blank": 1,             // https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-no-target-blank.md
    ...
    "overrides": [
        {
            "files": ["*.ts", "*.tsx"],
            "rules": {
                // Overrides from @typescript-eslint/eslint:recommended https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/src/configs/eslint-recommended.ts (all errors set to warn)
                ...
                // All rules from https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/src/configs/recommended.ts
