...
namespace TypeScriptAnalyzerEslintTest
{
    ...
    public class ParserTest
    {
        ...
        public async Task ParserIncorrectlySpecified()
        {
            ...
            Assert.IsTrue(result.Errors.First().Message.StartsWith("ESLint webserver error. For more details see Output window: Failed to load parser"));
        }
        ...
        public async Task EspreeParserSpecified()
        {
            ...
            Assert.AreEqual(null, result.Errors.First().ErrorCode);  // Error is not generated by the linter, but by being unable to parse
        }
